...
const tourSchema = new mongoose.Schema(
  {
    ...
    priceDiscount: {
      type: Number,
      // thiết kế validate cho trường price
      validate: {
        validator: function (val) {
          // this only points to current doc on New document creation
          // validate trong create doc, không ảnh hưởng trtong update doc
          return val < this.price; // 100 < 250 (true)
        },
